...
from database.admin_database import add_admin, present_admin, full_adminbase, del_admin
    ...
    if(len(data) != 3 or data[2] not in admin_levels):
        ...
        if not await present_admin(int(data[1])):
            try:
                ...
                client.send_message(chat_id=message.chat.id, text = data[1] + "\n" + data[2] + "\n")
                client.send_message(chat_id=message.chat.id, text = e)
